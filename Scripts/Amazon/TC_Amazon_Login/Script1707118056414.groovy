...
WebUI.setText(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign-In/input_email'), username)

WebUI.click(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign-In/inputcontinue'))

WebUI.setText(findTestObject('Object Repository/Amazon_Login_OR/Page_Amazon Sign-In/input_password'), password)
